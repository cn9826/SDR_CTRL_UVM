...
# SRAM IF signals
add wave -position insertpoint -group "SRAM IF" /tb_core/sdr_init_done
add wave -position insertpoint -group "SRAM IF" /tb_core/sdr_cke
add wave -position insertpoint -group "SRAM IF" /tb_core/sdr_addr
add wave -position insertpoint -group "SRAM IF" /tb_core/sdr_cs_n
add wave -position insertpoint -group "SRAM IF" /tb_core/sdr_ras_n
add wave -position insertpoint -group "SRAM IF" /tb_core/sdr_cas_n
add wave -position insertpoint -group "SRAM IF" /tb_core/sdr_we_n
add wave -position insertpoint -group "SRAM IF" /tb_core/sdr_dout
